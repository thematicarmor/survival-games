package supercoder79.survivalgames.noise.simplex;
...
public class OpenSimplexNoise implements NoiseSampler2d {
    ...
    public static Noise create() {
        return CustomNoise.of(OpenSimplexNoise::new, NoiseSampler2d.TYPE, NoiseRange.NORMAL);
    }
