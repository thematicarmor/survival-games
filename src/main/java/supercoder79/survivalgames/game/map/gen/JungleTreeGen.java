...
public class JungleTreeGen implements MapGen {
	public static final MapGen INSTANCE = new JungleTreeGen(Blocks.JUNGLE_LOG.getDefaultState(), Blocks.JUNGLE_LEAVES.getDefaultState().with(Properties.DISTANCE_1_7, 1), 16);
	private final BlockState log;
	private final BlockState leaves;
	private final int height;

	public JungleTreeGen(BlockState log, BlockState leaves, int height) {
		this.log = log;
		this.leaves = leaves;
		this.height = height;
	}
